...
class AdvertController extends Controller
{
  public function indexAction($page)
  {
    ...
    return $this->render('yoPlatformBundle:Advert:index.html.twig', array(
  ...
  public function viewAction($id)
  {
    ...
    return $this->render('yoPlatformBundle:Advert:view.html.twig', array(
      'advert' => $advert
    ));
  }
  ...
  public function addAction(Request $request)
  {
    ...
    if ($request->isMethod('POST')) {
      ...
      return $this->redirect($this->generateUrl('yo_platform_view', array('id' => 5)));
    }
  ...
  public function editAction($id, Request $request)
  {
    ...
    return $this->render('yoPlatformBundle:Advert:edit.html.twig', array(
      'advert' => $advert
    ));
  }
